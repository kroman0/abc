/**
 * @license AngularJS v1.2.3-a35d08d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-a35d08d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-a35d08d',    // all of these placeholder strings will be replaced by grunt's
